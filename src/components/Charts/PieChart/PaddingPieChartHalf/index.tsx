...
import {
  ...
  titleChartCard,
  titleSize,
} from './PaddingPieChartHalf.css';
import { useColorScheme } from '@/providers';
import { clsx } from 'clsx';
import { theme } from '@/core/themes/default.css';

interface PaddingPieChartHalfProps {
  data: any[];
  header: { title: string; subtitle: string };
  colors: string[];
}

export const PaddingPieChartHalf: React.FC<PaddingPieChartHalfProps> = ({
  data,
  header,
  colors,
}) => {
...
PaddingPieChartHalf.displayName = 'PaddingPieChartHalf';
